...
public:
  ...
  AdaptiveSlidingModeControl()
  {
    ...
    static const float dk_x = 0.02;
    static const float dk_y = 0.02;
    ...
    static const float dmu_x = 0.1;
    static const float dmu_y = 0.1;
    static const float dtc_x = 10;
    static const float dtc_y = 10;
    ...
    static const float dtc_u = 3;
    static const float dtc_r = 3;
