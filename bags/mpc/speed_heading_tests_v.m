...
experimentbag = rosbag('u_0,7_psi_0,4v_2021-02-21-13-19-54.bag')
...
%heading plot
heading = select(experimentbag, "Topic", '/guidance/desired_heading');
...
title('Variable heading Thruster MPC')
%speed plot
...
title('Variable Heading Speed MPC')