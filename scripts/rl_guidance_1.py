...
#IMU data subscribers
        ...
        rospy.Subscriber("ins_ref", Pose2D, self.gpsref_callback)

#Thruster data publishers
        self.desired_speed_pub = rospy.Publisher("desired_speed", Float64, queue_size=10)
        self.desired_heading_pub = rospy.Publisher("desired_heading", Float64, queue_size=10)
...
def main():
    ...
    rl_guidance.actor_model.load_weights('/home/alex/Documents/rasp_ws/src/sensors/scripts/weights/guidance/experiment1')
