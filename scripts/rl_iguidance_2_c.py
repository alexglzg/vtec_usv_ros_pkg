...
NODE_NAME_THIS = 'rl_iguidance_2_c'
...
#Thruster data publishers
    ...
    def guidance_law(self, x1, y1, x2, y2):
        ...
        if np.sign(ye) != np.sign(self.ye_last):
            self.ye_int = 0
        ...
        state = np.array([self.u, v_ak, self.r, ye + self.k_i*self.ye_int, psi_ak, self.last_action])
...
def main():
    ...
    rl_guidance.time_step = 1./frequency
